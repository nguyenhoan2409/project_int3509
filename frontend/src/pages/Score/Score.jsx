            ...
            <table className="score-table-user">
              <thead>
                <tr className="score-table-tr">
                  ...
                  <th className="swimming score-table-header">Cầu lông</th>
                  ...
                  <th className="traditional_gymnastics score-table-header">Thể dục cổ truyền</th>
                  <th className="basic_fitness score-table-header">Thể dục cơ bản</th>
              ...
              <tbody>
                {scores?.slice(
                  ...
                  <tr className="score-table-tr" key={index}>
                    ...
                    <td className="swimming">{score.swimming_score}</td>
                    ...
                    <td className="traditional_gymnastics">{score.traditional_gymnastics_score}</td>
                    <td className="basic_fitness">{score.basic_fitness_score}</td>
