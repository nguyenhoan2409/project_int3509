...
export const NotificationPage = () => {
  ...
  const getNotification = async () => {
    try {
      const response = await axios.get("/home/notification");
      setNotificationList([]);
  ...
  const updateNotification = async (id) => {
    try {
      const response = await axios.put("/admin/notification/update", {
        notification_id: id,
        tittle: newTittle,
        content: newContent,
      });
        ...
        <div className="hero-main-admin">
          ...
          <div className="create-notification-admin">
            ...
            <div className="create-notification-form">
              <input
                className="create-noti-header"
                placeholder="Tiêu đề"
                onChange={handleInputTittle}
                value={tittle}
              />
              <textarea
                className="create-noti-content"
                placeholder="Nội dung"
                onChange={handleInputContent}
                value={content}
              />
              <button
                className="create-notification-btn-admin"
            ...
            {notificationList?.map((notification) => (
              ...
              >
                <img
                  ...
                  alt=""
                  className="notification-img-admin"
                />
                <div className="notification-right-admin">
                  ...
                  >
                    <div className="notification-title-admin">
                      {notification.tittle}
                    </div>
                    <CiEdit
                      style={{
                  ...
                  <div className="notification-content-admin">
                    ...
                    <div className="notification-time-admin">
                      {" "}
                      Ngày đăng : {notification.create_time}
                    </div>
                  </div>

                  <button
                    className="notification-btn-admin"
            ...
            {open === true && (
              ...
              >
                <div className="notification-header-admin">
                  ...
                  <p className="notification-close-admin" onClick={handleClose}>
                    X{" "}
                  </p>
                </div>
                <div className="create-noti-header">
                  {notificationDetail.tittle}
                </div>
                ...
                <div className="notification-time-admin">
                  {" "}
                  Ngày đăng : {notificationDetail.create_time}
                </div>
              </Modal>
            )}
            ...
            {openEdit === true && (
              ...
              >
                <div className="notification-header-admin">
                  ...
                  <p
                    className="notification-close-admin"
