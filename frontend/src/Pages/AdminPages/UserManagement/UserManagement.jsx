      ...
      >
        ...
        <div className="search-user">
                ...
                <div className="search-btn-admin">
                  <button className="search-score-btn-admin" onClick={() => searchUser()}>Tìm kiếm</button>
                </div>
        </div>
        ...
        <TableBody>
           {users?.map((user) => (
            <StyledTableRow key={user._id}>
              ...
              <StyledTableCell align="right">{user.role_id === 1 ? "Admin" : <Button onClick={() => userToAdmin(user.user_id)}> Cấp quyền admin </Button>}</StyledTableCell>
            </StyledTableRow>
           ))}
            <StyledTableRow>
