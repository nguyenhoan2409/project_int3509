    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return database.query("INSERT INTO physicalscore (mssv, fullname, class, university) VALUES(:mssv, :fullname, :class, :university)", {
            replacements: {
              mssv: req.body.mssv,
        ...
        case 3:
          ...
          return _context.abrupt("return", res.status(200).json({
            msg: "Thêm danh sách sinh viên thành công"
          }));
        case 7:
          _context.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 13;
          return database.query("UPDATE physicalscore SET ".concat(subject, "=:score WHERE mssv =:mssv"), {
            replacements: {
...
exports.getAllScore = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return database.query("SELECT * FROM physicalscore", {
...
exports.searchScore = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          mssv = req.params.id;
          _context4.next = 4;
          return database.query("SELECT * FROM physicalscore WHERE mssv = :mssv", {
            replacements: {
              mssv: mssv
            },
            type: QueryTypes.SELECT
...
exports.updateScore = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          student = database.query("UPDATE physicalscore SET football_score=:football_score, badminton_score=:badminton_score, tabletennis_score=:tabletennis_score, basketball_score=:basketball_score, air_volleyball_score=:air_volleyball_score, volleyball_score=:volleyball_score, taekwondo_score=:taekwondo_score, golf_score=:golf_score WHERE mssv =:mssv", {
            replacements: {
...
exports.updateCDR = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var list, i, mssv, count, CDR;
...
exports.checkCDR = /*#__PURE__*/function () {
      ...
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          return _context7.abrupt("return", res.status(200).json({
            msg: "Bạn đã đạt chuẩn đầu ra"
          }));
        case 9:
          return _context7.abrupt("return", res.status(200).json({
            msg: "Bạn chưa đạt chuẩn đầu ra"
          }));
        case 10:
          _context7.next = 15;
          break;
...
exports.deleteSTudentList = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          mssv = list[i].mssv;
          _context8.next = 8;
          return database.query("DELETE FROM physicalscore WHERE mssv=:mssv", {
            replacements: {
              mssv: mssv
            },
